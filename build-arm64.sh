...
#OpenBLAS Compile
make TARGET=CORTEXA57 NOFORTRAN=1 USE_THREAD=0 NUM_THREADS=4 AR=$NDKROOT/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/aarch64-linux-android/bin/ar CC="$NDKROOT/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang ${CLANG_FLAGS}" HOSTCC=gcc

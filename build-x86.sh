...
make BINARY=32 NOFORTRAN=1 USE_THREAD=0 NUM_THREADS=1 AR=$NDKROOT/toolchains/x86-4.9/prebuilt/darwin-x86_64/i686-linux-android/bin/ar CC="$NDKROOT/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang ${CLANG_FLAGS}" HOSTCC=gcc LDFLAGS=$LDFLAGS

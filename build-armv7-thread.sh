...
#OpenBLAS Compile
make TARGET=ARMV7 NOFORTRAN=1 USE_THREAD=1 NUM_THREADS=4 USE_LOCKING=1 AR=$NDKROOT/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/arm-linux-androideabi/bin/ar CC="$NDKROOT/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang ${CLANG_FLAGS}" HOSTCC=gcc ARM_SOFTFP_ABI=1 LDFLAGS=$LDFLAGS
make PREFIX=$PWD/output/armv7_multi_thread/ NOFORTRAN=0 install
